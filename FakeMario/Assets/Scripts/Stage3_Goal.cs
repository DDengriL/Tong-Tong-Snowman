...
public class Stage3_Goal : MonoBehaviour
{
    ...
    public IEnumerator Goal()
    {
        ...
        player.transform.position = new Vector3(228f, player.transform.position.y,player.transform.position.z);
        ...
        while(player.transform.position.y >= -3.139f)
        {
        ...
        while(player.transform.position.x <= 235.74f)
        {
        ...
        SceneManager.LoadScene("Leaderboard_3");
    }
