...
public class Stage1_Goal : MonoBehaviour
{
    ...
    public IEnumerator Goal()
    {
        ...
        player.transform.position = new Vector3(53.83f, player.transform.position.y,player.transform.position.z);
        ...
        while(player.transform.position.y >= -0.23f)
        {
        ...
        while(player.transform.position.x <= 58.12f)
        {
