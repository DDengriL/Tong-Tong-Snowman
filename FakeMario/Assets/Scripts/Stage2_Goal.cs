...
public class Stage2_Goal : MonoBehaviour
{
    ...
    public IEnumerator Goal()
    {
        ...
        player.transform.position = new Vector3(191.34f, player.transform.position.y,player.transform.position.z);
        ...
        while(player.transform.position.y >= -3.16f)
        {
        ...
        while(player.transform.position.x <= 199.08f)
        {
        ...
        for (float i = 2.5f; i >= 0.0925f; i -= 0.01f * Time.deltaTime * 300)
        {
        ...
        SceneManager.LoadScene("level2_clear");
    }
    ...
    IEnumerator Player_Opacity()
    {
        ...
        for (float i = 1.0f; i >= 0.0f; i -= 0.003f * Time.deltaTime * 300)
        {
            color.a = i;
